...
sealed class Screens( var route:String){
    ...
    data object CommunityScreen:Screens("community_screen")
    data object VolunteerProfileForm:Screens("volunteer_profile")
    ...
    data object NgoDetailScreen:Screens("ngo_detail/{id}")
